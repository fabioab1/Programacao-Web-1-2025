        ...
        <form method="post" action="/viagens">
            ...
            <div class="mb-3">
                ...
                <div class="form-check ">
                    <input type="radio" id="diaria" name="tipo_viagem" class="form-check-input" value="1">
                    <label for="diaria" class="form-check-label">Viagem diária</label>
                </div>

                <div class="form-check ">
                    <input type="radio" id="esporadica" name="tipo_viagem" class="form-check-input" value="0">
            ...
            <div class="mb-3">
                ...
                <input type="time" id="horario_embarque" name="horario_embarque" class="form-control" required="">
            </div>
