...
<body>
    ...
    <div class="container my-4">
        ...
        <form method="post" action="/viagens/{{ $viagem->id }}">
            ...
            <div class="mb-3">
                ...
                <select id="motorista" name="id_motorista" class="form-select" required="">
            ...
            <div class="mb-3">
                ...
                <div class="form-check ">
                    <input type="radio" id="diaria" name="tipo_viagem" class="form-check-input" value="1" {{ $viagem->tipo_viagem == 1 ? "checked" : "" }}>
                    <label for="diaria" class="form-check-label">Viagem diária</label>
                </div>

                <div class="form-check ">
                    <input type="radio" id="esporadica" name="tipo_viagem" class="form-check-input" value="0" {{ $viagem->tipo_viagem == 0 ? "checked" : "" }}>
            ...
            <div class="mb-3">
                ...
                <div class="form-check ">
                    <input type="checkbox" id="domingo" name="domingo" value="1" class="form-check-input" {{ $viagem->domingo == 1 ? "checked" : "" }}>
                    <label for="domingo" class="form-check-label">Domingo</label>
                </div>

                <input type="hidden" name="segunda" value="0">
                <div class="form-check ">
                    <input type="checkbox" id="segunda" name="segunda" value="1" class="form-check-input" {{ $viagem->segunda == 1 ? "checked" : "" }}>
                    <label for="segunda" class="form-check-label">Segunda-feira</label>
                </div>

                <input type="hidden" name="terca" value="0">
                <div class="form-check ">
                    <input type="checkbox" id="terca" name="terca" value="1" class="form-check-input" {{ $viagem->terca == 1 ? "checked" : "" }}>
                    <label for="terca" class="form-check-label">Terça-feira</label>
                </div>

                <input type="hidden" name="quarta" value="0">
                <div class="form-check ">
                    <input type="checkbox" id="quarta" name="quarta" value="1" class="form-check-input" {{ $viagem->quarta == 1 ? "checked" : "" }}>
                    <label for="quarta" class="form-check-label">Quarta-feira</label>
                </div>

                <input type="hidden" name="quinta" value="0">
                <div class="form-check ">
                    <input type="checkbox" id="quinta" name="quinta" value="1" class="form-check-input" {{ $viagem->quinta == 1 ? "checked" : "" }}>
                    <label for="quinta" class="form-check-label">Quinta-feira</label>
                </div>

                <input type="hidden" name="sexta" value="0">
                <div class="form-check ">
                    <input type="checkbox" id="sexta" name="sexta" value="1" class="form-check-input" {{ $viagem->sexta == 1 ? "checked" : "" }}>
                    <label for="sexta" class="form-check-label">Sexta-feira</label>
                </div>

                <input type="hidden" name="sabado" value="0">
                <div class="form-check ">
                    <input type="checkbox" id="sabado" name="sabado" value="1" class="form-check-input" {{ $viagem->sabado == 1 ? "checked" : "" }}>
            ...
            <div class="mb-3">
                ...
                <input type="date" id="data" name="data" class="form-control" value="{{ $viagem->tipo_viagem == 1 ? '' : $viagem->data}}">
            </div>

            <div class="mb-3">
                <label for="horario_embarque" class="form-label">Horário de embarque:</label>
                <input type="time" id="horario_embarque" name="horario_embarque" class="form-control" value="{{ $viagem->horario_embarque }}" required="">
            </div>

            <div class="mb-3">
                <label for="horario_saida" class="form-label">Horário de saída:</label>
                <input type="time" id="horario_saida" name="horario_saida" class="form-control" value="{{ $viagem->horario_saida }}" required="">
            </div>

            <div class="mb-3">
                <label for="horario_chegada" class="form-label">Horário de chegada:</label>
                <input type="time" id="horario_chegada" name="horario_chegada" class="form-control" value="{{ $viagem->horario_chegada }}" required="">
            </div>
    ...
    <script>
        ...
        let esporadica = document.getElementById("esporadica");
        ...
        diaria.addEventListener('change', atualizarCampos);
        esporadica.addEventListener('change', atualizarCampos);
